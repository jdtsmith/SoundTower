...
// -- use <i2 to force LE on numpy side (then tobytes()), and on
// browser side, use dataview's getUint16 with littleEndian argument
// set to true to read the ArrayBuffer as LE 16-bit bytes.  
